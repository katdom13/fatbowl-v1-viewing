      ...
      <Box paddingTop={3}>
        <Grid container spacing={2}>
          <Grid item xs={12} sm>
            ...
            <Typography component='small' color='textPrimary' variant='caption'>&copy; 2017-2021</Typography>
          </Grid>
          <Grid item xs={6} sm>
            <Typography component='h5' variant='h6' gutterBottom>Features</Typography>
          ...
          <Grid item xs={6} sm>
            <Typography component='h5' variant='h6' gutterBottom>Resources</Typography>
          ...
          <Grid item xs={6} sm>
            <Typography component='h5' variant='h6' gutterBottom>About</Typography>
