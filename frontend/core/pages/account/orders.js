            ...
            }
            {
              orders && orders.map(order => (
                <Fragment key={order.id}>
                  <Grid item xs={12}>
                    <Box display='flex' alignItems='center' className={classes.orderDetails}>
                      <Hidden mdUp>
                        <Grid container>
                          <Grid item xs={12}>
                            <Box>
                          ...
                          <Grid item xs={12}>
                            <Button
                              ...
                              onClick={event => setAnchors({...anchors, [order.id]: event.currentTarget})}
                            >
                                <Typography variant='body1'>
                                  Dispatched to
                                </Typography>
                                {
                                  Boolean(anchors[order.id]) ? <ExpandLessIcon color='action' /> : <ExpandMoreIcon color='action' />
                                }
                            </Button>
                          </Grid>
                          <Grid item xs={12}>
