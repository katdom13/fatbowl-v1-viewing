...
CORS_EXPOSE_HEADERS = ["Content-Type", "X-CSRFToken", "content-type", "x-csrftoken"]

# If True, cookies will be allowed to be included in cross-site HTTP requests.
CORS_ALLOW_CREDENTIALS = True

CSRF_TRUSTED_ORIGINS = ["https://www.development.fatbowl.net/"]
...
STATIC_URL = (
    f"https://{AWS_S3_CUSTOM_DOMAIN}/{STATIC_LOCATION}/" if FROM_DOCKER else "/static/"
)
